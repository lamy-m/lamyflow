...
This is a introduction the Rpackage "lamyflow". This package helps to reproduce the github page [lamy-m.github.io](https://lamy-m.github.io/index.html).It contains 4 data files and 4 functions. 
...
After installiation the package can be called as following: 
...
This package contains four datasets that have been used in the github page [lamy-m.github.io](https://lamy-m.github.io/index.html). To load in the dataste use the function `{data}`
...
Use "?" before the function to see their documention. 
